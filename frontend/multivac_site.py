...
def route_index_page():
    ...
    if request.method == 'POST':
        # Read in post parameters. If key is not located in the request, this will raise an exception.
        # Input validation of parameters is taken care of by the start_multivac_session() function call.
